"""
Django settings for django_misc project.
...
SECRET_KEY = '0k81sgh^3mfi&g1=5fzq5aapq=e)is881k8g8whwogx@a=9edc'
...
MIDDLEWARE = [
    ...
    'django_misc.custom_middlewares.custom_middlewares.LoggingMiddleWare'
]

if DEBUG:
    MIDDLEWARE.append('debug_toolbar.middleware.DebugToolbarMiddleware')
    DEBUG_TOOLBAR_CONFIG = {
        'SHOW_TOOLBAR_CALLBACK': 'django_misc.settings.show_debug_toolbar',
    }

ROOT_URLCONF = 'django_misc.urls'
...
WSGI_APPLICATION = 'django_misc.wsgi.application'
